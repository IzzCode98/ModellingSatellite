# -*- coding: utf-8 -*-
"""
Created on Mon Nov 14 15:08:43 2016
...
for k in np.arange(esc_v_split, 10000, 100):
    ...
    pl.figure(1)    
    pl.plot (vinit, angledev , 'r+')
    pl.ylabel('Angle of Deviation (rad)')
    pl.xlabel('Initial Velocity (m/s)')
    pl.axvline (x=escape_v, color='b', linestyle='--')
