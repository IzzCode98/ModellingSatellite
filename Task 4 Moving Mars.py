...
V_mars=24100 #m/s #velocity of Mars (in the x direction)
...
for k in np.arange(0, 10000, 100):
    ...
    initial=[x_initial, y_initial, -k+24100, k]
    ...
    if k == example_velocity:
        ...
        if k <= esc_v_split:
            ...
            if min(collide) <= R_m:
                print 'Satellite has crashed: it had initial velocity of', vinit 
